                ...
                <div className={classes.checkmarkwrapper}>
                    <div className={classes.checkmark}>
                        <div className={classes.checkmarkCheckedState}>
                            <svg width="14" height="14" viewBox="0 0 24 24"><path fill="white" fillRule="evenodd" clipRule="evenodd" d="M8.99991 16.17L4.82991 12L3.40991 13.41L8.99991 19L20.9999 7.00003L19.5899 5.59003L8.99991 16.17Z"></path></svg>
                        </div>
                    </div>
                </div>
